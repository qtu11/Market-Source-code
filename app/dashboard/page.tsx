...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    // ✅ Set interval với UPDATE_INTERVAL dài hơn (30s thay vì 5s)
      ...
      <main className="container mx-auto px-4 pt-24 pb-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <TabsList className="flex flex-wrap gap-2">
            ...
            <TabsTrigger value="analytics">Analytics cá nhân</TabsTrigger>
            ...
            <TabsContent value="purchases" className="space-y-4 bg-white/60 dark:bg-black/50">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                          ...
                          >
                            <StarIcon
                              className={`w-4 h-4 mr-1 ${
                                showFavoritesOnly ? "text-yellow-300" : ""
                              }`}
                            />
                            Yêu thích
                          </Button>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-2 mt-2">
                              ...
                              >
                                <StarIcon
                                  className={`w-4 h-4 ${
                                    wishlistIds.includes(String(purchase.id))
            ...
            <TabsContent value="referrals" className="space-y-4 bg-white/60 dark:bg-black/50">
              <ReferralProgram
            ...
            <TabsContent value="coupons" className="space-y-4 bg-white/60 dark:bg-black/50">
              <CouponsCenter
            ...
            <TabsContent value="devices" className="space-y-4 bg-white/60 dark:bg-black/50">
              <DeviceManagement
            ...
            <TabsContent value="analytics" className="space-y-4 bg-white/60 dark:bg-black/50">
              <PersonalAnalytics
            ...
            <TabsContent value="reviews" className="space-y-4 bg-white/60 dark:bg-black/50">
              <ReviewManager
            ...
            <TabsContent value="downloads" className="space-y-4 bg-white/60 dark:bg-black/50">
              <DownloadHistory
            ...
            <TabsContent value="wishlist" className="space-y-4 bg-white/60 dark:bg-black/50">
              <Card>
            ...
            <TabsContent value="deposits" className="space-y-4 bg-white/60">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
            ...
            <TabsContent value="withdrawals" className="space-y-4 bg-white/60">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
            ...
            <TabsContent value="activity" className="space-y-4 bg-white/60 dark:bg-black/50">
              <Card>
            ...
            <TabsContent value="notifications" className="space-y-4 bg-white/60 dark:bg-black/50">
              <NotificationCenter />
            </TabsContent>

            <TabsContent value="support" className="space-y-4 bg-white/60 dark:bg-black/50">
            ...
            <TabsContent value="profile" className="space-y-4 bg-white/60">
            ...
            <TabsContent value="security" className="space-y-4 bg-white/60 dark:bg-black/50">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
